...
func TestMapType(t *testing.T) {
	tests := []struct {
		...
		{"json→jsonb default", Column{DataType: "json", ColumnType: "json"}, defaultTypeMappingConfig(), "jsonb", false},
		{"json→json opt-out", Column{DataType: "json", ColumnType: "json"}, TypeMappingConfig{JSONAsJSONB: false, EnumMode: "text", SetMode: "text", SanitizeJSONNullBytes: true}, "json", false},
