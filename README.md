...
- Preflight `plan` command reports views, routines, triggers, generated columns, skipped indexes, orphan-cleanup risks, required extensions, and collation warnings before PostgreSQL is touched
