...
- Some type mapping options are MySQL-only (`tinyint1_as_boolean`, `binary16_as_uuid`, `datetime_as_timestamptz`, `enum_mode`, `set_mode`); SQLite sources reject these at config validation
