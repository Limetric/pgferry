...
| How do I inspect resume progress without opening JSON manually? | [Migration Pipeline](/reference/migration-pipeline/#resume-behavior) and [Conventions & limitations](/reference/conventions-and-limitations/#checkpoint-behavior) |
